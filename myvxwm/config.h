...
static const int bottom_vertpad = 2;       /* bottom vertical padding of bar */
static const int left_sidepad = 450;         /* left horizontal padding of bar */
static const int right_sidepad = 450;        /* right horizontal padding of bar */
#endif
...
static const Key keys[] = {
  ...
  /* ScreenShots */
  { 0,                            XK_Print,  spawn,          SHCMD("~/ss-area.sh") },
